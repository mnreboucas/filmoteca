 ...
 */
final class Version20220430135107 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE filme (id INT AUTO_INCREMENT NOT NULL, genero_id INT DEFAULT NULL, titulo VARCHAR(255) NOT NULL, ano INT DEFAULT NULL, pais VARCHAR(255) DEFAULT NULL, diretor VARCHAR(255) DEFAULT NULL, observacao VARCHAR(255) DEFAULT NULL, localizacao VARCHAR(255) DEFAULT NULL, INDEX IDX_3A387F00BCE7B795 (genero_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE filme_premio (id INT AUTO_INCREMENT NOT NULL, filme_id INT NOT NULL, premio_id INT NOT NULL, ano INT DEFAULT NULL, INDEX IDX_11B75FBDE6E418AD (filme_id), INDEX IDX_11B75FBDFB5CD01B (premio_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(180) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_8D93D649F85E0677 (username), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB');
